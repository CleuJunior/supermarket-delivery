...
* The original package name 'br.com.smd.products.supermarket-delivery-products' is invalid and this project uses 'br.com.smd.products.supermarket_delivery_products' instead.
